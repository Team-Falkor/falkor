...
const buttonVariants = cva(
  "inline-flex items-center cursor-pointer justify-center whitespace-nowrap rounded-full text-sm font-medium transition-colors disabled:pointer-events-none disabled:opacity-50 ring-0 capitalize",
  {
    variants: {
      variant: {
        ...
        warning:
          "bg-yellow-700 textsecondary-foreground hover:bg-yellow-700/90",
        outline:
